...
Structure: **6 sections + footer.** Hero → Proof bento → Featured case (Yokogawa) → Case carousel (Clinical AI + Kintsugi, same fold) → About → Experience → Footer. One separate page: the full Yokogawa case study.
